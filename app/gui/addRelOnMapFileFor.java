...
public class addRelOnMapFileFor extends DefaultInternalAction {
    ...
    public Object execute(final TransitionSystem ts, Unifier un, Term[] args) throws Exception {
		...
		// get the new prop to add
        String prop = ((StringTerm)args[0]).getString();
		// get the new image for prop to add
        String img = ((StringTerm)args[1]).getString();
		// get the name of Set file
        String file = ((StringTerm)args[2]).getString();
		// get the name of Bot
        String botName = ((StringTerm)args[3]).getString();
